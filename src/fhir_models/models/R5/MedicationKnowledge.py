...
class PatientCharacteristic(FhirBaseModel):
...
class DosingGuideline(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "patientCharacteristic": {
            "class_name": "PatientCharacteristic",
            "is_contained": True,
        },
    }
    ...
    def __init__(
        ...
        patientCharacteristic: list["PatientCharacteristic"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class IndicationGuideline(FhirBaseModel):
    ...
    def __init__(
        ...
        dosingGuideline: list["DosingGuideline"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class EnvironmentalSetting(FhirBaseModel):
...
class StorageGuideline(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "environmentalSetting": {
            "class_name": "EnvironmentalSetting",
            "is_contained": True,
        },
    }
    ...
    def __init__(
        ...
        environmentalSetting: list["EnvironmentalSetting"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Definitional(FhirBaseModel):
...
class MedicationKnowledge(DomainResource):
    ...
    property_class_info = {
        ...
        "indicationGuideline": {
            "class_name": "IndicationGuideline",
            "is_contained": True,
        },
