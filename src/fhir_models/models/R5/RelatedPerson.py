...
class Communication(FhirBaseModel):
    """A language which may be used to communicate with the related person about the patient's health.:param str id: Unique id for inter-element referencing
...
class RelatedPerson(DomainResource):
    ...
    :param Communication communication: A language which may be used to communicate with the related person about the patient's health
    """
