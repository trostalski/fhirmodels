...
class Link(FhirBaseModel):
    """Link to a Patient or RelatedPerson resource that concerns the same actual individual.:param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
...
class Patient(DomainResource):
    ...
    :param Link link: Link to a Patient or RelatedPerson resource that concerns the same actual individual
    """
