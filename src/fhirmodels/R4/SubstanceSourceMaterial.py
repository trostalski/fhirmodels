...
class OrganismGeneral(FhirBaseModel):
...
class PartDescription(FhirBaseModel):
...
class SubstanceSourceMaterial(DomainResource):
    ...
    property_class_info = {
        ...
        "fractionDescription": {"class_name": "FractionDescription", "is_contained": True},
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  sourceMaterialClass:  'CodeableConcept'  = None,  sourceMaterialType:  'CodeableConcept'  = None,  sourceMaterialState:  'CodeableConcept'  = None,  organismId:  'Identifier'  = None,  organismName:  'str'  = None,  parentSubstanceId:  list['Identifier']  = None,  parentSubstanceName:  list['str']  = None,  countryOfOrigin:  list['CodeableConcept']  = None,  geographicalLocation:  list['str']  = None,  developmentStage:  'CodeableConcept'  = None,  fractionDescription:  list['FractionDescription']  = None,  organism:  'Organism'  = None,  partDescription:  list['PartDescription']  = None, ):
        
        self.resourceType = "SubstanceSourceMaterial"
