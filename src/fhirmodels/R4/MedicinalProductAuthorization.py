...
class Procedure(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  'Identifier'  = None,  type:  'CodeableConcept'  = None,  datePeriod:  'Period'  = None,  dateDateTime:  'str'  = None,  application:  list['Application']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class MedicinalProductAuthorization(DomainResource):
    ...
    property_class_info = {
        ...
        "jurisdictionalAuthorization": {"class_name": "JurisdictionalAuthorization", "is_contained": True},
