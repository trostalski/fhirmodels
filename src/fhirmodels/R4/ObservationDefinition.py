...
class QuantitativeDetails(FhirBaseModel):
...
class QualifiedInterval(FhirBaseModel):
...
class ObservationDefinition(DomainResource):
    ...
    property_class_info = {
        ...
        "quantitativeDetails": {"class_name": "QuantitativeDetails", "is_contained": True},
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  category:  list['CodeableConcept']  = None,  code:  'CodeableConcept'  = None,  identifier:  list['Identifier']  = None,  permittedDataType:  list['str']  = None,  multipleResultsAllowed:  'bool'  = None,  method:  'CodeableConcept'  = None,  preferredReportName:  'str'  = None,  quantitativeDetails:  'QuantitativeDetails'  = None,  qualifiedInterval:  list['QualifiedInterval']  = None,  validCodedValueSet:  'Reference'  = None,  normalCodedValueSet:  'Reference'  = None,  abnormalCodedValueSet:  'Reference'  = None,  criticalCodedValueSet:  'Reference'  = None, ):
