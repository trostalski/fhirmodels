...
from fhirmodels.R4.ProdCharacteristic import *
from fhirmodels.R4.ProductShelfLife import *
from fhirmodels.R4.Quantity import *
from fhirmodels.R4.Reference import *
from fhirmodels.R4.Resource import *


class BatchIdentifier(FhirBaseModel):
...
class PackageItem(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "physicalCharacteristics": {"class_name": "ProdCharacteristic", "is_contained": False},
        
        
        "otherCharacteristics": {"class_name": "CodeableConcept", "is_contained": False},
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  type:  'CodeableConcept'  = None,  quantity:  'Quantity'  = None,  material:  list['CodeableConcept']  = None,  alternateMaterial:  list['CodeableConcept']  = None,  device:  list['Reference']  = None,  manufacturedItem:  list['Reference']  = None,  packageItem:  list['PackageItem']  = None,  physicalCharacteristics:  'ProdCharacteristic'  = None,  otherCharacteristics:  list['CodeableConcept']  = None,  shelfLifeStorage:  list['ProductShelfLife']  = None,  manufacturer:  list['Reference']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class MedicinalProductPackaged(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  subject:  list['Reference']  = None,  description:  'str'  = None,  legalStatusOfSupply:  'CodeableConcept'  = None,  marketingStatus:  list['MarketingStatus']  = None,  marketingAuthorization:  'Reference'  = None,  manufacturer:  list['Reference']  = None,  batchIdentifier:  list['BatchIdentifier']  = None,  packageItem:  list['PackageItem']  = None, ):
        ...
        self.resourceType = "MedicinalProductPackaged"
