...
from fhirmodels.R4.MarketingStatus import *
...
class ManufacturingBusinessOperation(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "authorisationReferenceNumber": {"class_name": "Identifier", "is_contained": False},
...
class SpecialDesignation(FhirBaseModel):
...
class MedicinalProduct(DomainResource):
    ...
    property_class_info = {
        ...
        "paediatricUseIndicator": {"class_name": "CodeableConcept", "is_contained": False},
        
        
        "productClassification": {"class_name": "CodeableConcept", "is_contained": False},
        ...
        "manufacturingBusinessOperation": {"class_name": "ManufacturingBusinessOperation", "is_contained": True},
        
        
        "specialDesignation": {"class_name": "SpecialDesignation", "is_contained": True},
        
        }
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  type:  'CodeableConcept'  = None,  domain:  'Coding'  = None,  combinedPharmaceuticalDoseForm:  'CodeableConcept'  = None,  legalStatusOfSupply:  'CodeableConcept'  = None,  additionalMonitoringIndicator:  'CodeableConcept'  = None,  specialMeasures:  list['str']  = None,  paediatricUseIndicator:  'CodeableConcept'  = None,  productClassification:  list['CodeableConcept']  = None,  marketingStatus:  list['MarketingStatus']  = None,  pharmaceuticalProduct:  list['Reference']  = None,  packagedMedicinalProduct:  list['Reference']  = None,  attachedDocument:  list['Reference']  = None,  masterFile:  list['Reference']  = None,  contact:  list['Reference']  = None,  clinicalTrial:  list['Reference']  = None,  name:  list['Name']  = None,  crossReference:  list['Identifier']  = None,  manufacturingBusinessOperation:  list['ManufacturingBusinessOperation']  = None,  specialDesignation:  list['SpecialDesignation']  = None, ):
        
        self.resourceType = "MedicinalProduct"
