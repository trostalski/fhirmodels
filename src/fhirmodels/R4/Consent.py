...
class Provision(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  type:  'str'  = None,  period:  'Period'  = None,  actor:  list['Actor']  = None,  action:  list['CodeableConcept']  = None,  securityLabel:  list['Coding']  = None,  purpose:  list['Coding']  = None,  _class:  list['Coding']  = None,  code:  list['CodeableConcept']  = None,  dataPeriod:  'Period'  = None,  data:  list['Data']  = None,  provision:  list['Provision']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.type = type 
