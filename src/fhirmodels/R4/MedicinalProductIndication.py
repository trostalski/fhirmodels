...
from fhirmodels.R4.Population import *
...
class OtherTherapy(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "therapyRelationshipType": {"class_name": "CodeableConcept", "is_contained": False},
...
class MedicinalProductIndication(DomainResource):
    ...
    property_class_info = {
        ...
        "diseaseSymptomProcedure": {"class_name": "CodeableConcept", "is_contained": False},
