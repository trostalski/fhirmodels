...
class Resource(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  type:  'str'  = None,  profile:  'str'  = None,  supportedProfile:  list['str']  = None,  documentation:  'str'  = None,  interaction:  list['Interaction']  = None,  versioning:  'str'  = None,  readHistory:  'bool'  = None,  updateCreate:  'bool'  = None,  conditionalCreate:  'bool'  = None,  conditionalRead:  'str'  = None,  conditionalUpdate:  'bool'  = None,  conditionalDelete:  'str'  = None,  referencePolicy:  list['str']  = None,  searchInclude:  list['str']  = None,  searchRevInclude:  list['str']  = None,  searchParam:  list['SearchParam']  = None,  operation:  list['Operation']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.type = type 
...
class CapabilityStatement(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  url:  'str'  = None,  version:  'str'  = None,  name:  'str'  = None,  title:  'str'  = None,  status:  'str'  = None,  experimental:  'bool'  = None,  date:  'str'  = None,  publisher:  'str'  = None,  contact:  list['ContactDetail']  = None,  description:  'str'  = None,  useContext:  list['UsageContext']  = None,  jurisdiction:  list['CodeableConcept']  = None,  purpose:  'str'  = None,  copyright:  'str'  = None,  kind:  'str'  = None,  instantiates:  list['str']  = None,  imports:  list['str']  = None,  software:  'Software'  = None,  implementation:  'Implementation'  = None,  fhirVersion:  'str'  = None,  format:  list['str']  = None,  patchFormat:  list['str']  = None,  rest:  list['Rest']  = None,  messaging:  list['Messaging']  = None,  document:  list['Document']  = None, ):
