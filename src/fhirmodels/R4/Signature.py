...
class Signature(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  type:  list['Coding']  = None,  when:  'str'  = None,  who:  'Reference'  = None,  onBehalfOf:  'Reference'  = None,  targetFormat:  'str'  = None,  sigFormat:  'str'  = None,  data:  'str'  = None, ):
