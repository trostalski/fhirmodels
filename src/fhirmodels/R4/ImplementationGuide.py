...
class Resource(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  reference:  'Reference'  = None,  fhirVersion:  list['str']  = None,  name:  'str'  = None,  description:  'str'  = None,  exampleBoolean:  'bool'  = None,  exampleCanonical:  'str'  = None,  groupingId:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Page(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  nameUrl:  'str'  = None,  nameReference:  'Reference'  = None,  title:  'str'  = None,  generation:  'str'  = None,  page:  list['Page']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class ImplementationGuide(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  url:  'str'  = None,  version:  'str'  = None,  name:  'str'  = None,  title:  'str'  = None,  status:  'str'  = None,  experimental:  'bool'  = None,  date:  'str'  = None,  publisher:  'str'  = None,  contact:  list['ContactDetail']  = None,  description:  'str'  = None,  useContext:  list['UsageContext']  = None,  jurisdiction:  list['CodeableConcept']  = None,  copyright:  'str'  = None,  packageId:  'str'  = None,  license:  'str'  = None,  fhirVersion:  list['str']  = None,  dependsOn:  list['DependsOn']  = None,  _global:  list['_global']  = None,  definition:  'Definition'  = None,  manifest:  'Manifest'  = None, ):
