...
class SearchParameter(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  url:  'str'  = None,  version:  'str'  = None,  name:  'str'  = None,  derivedFrom:  'str'  = None,  status:  'str'  = None,  experimental:  'bool'  = None,  date:  'str'  = None,  publisher:  'str'  = None,  contact:  list['ContactDetail']  = None,  description:  'str'  = None,  useContext:  list['UsageContext']  = None,  jurisdiction:  list['CodeableConcept']  = None,  purpose:  'str'  = None,  code:  'str'  = None,  base:  list['str']  = None,  type:  'str'  = None,  expression:  'str'  = None,  xpath:  'str'  = None,  xpathUsage:  'str'  = None,  target:  list['str']  = None,  multipleOr:  'bool'  = None,  multipleAnd:  'bool'  = None,  comparator:  list['str']  = None,  modifier:  list['str']  = None,  chain:  list['str']  = None,  component:  list['Component']  = None, ):
