...
class DefinitionByTypeAndValue(FhirBaseModel):
...
class DefinitionByCombination(FhirBaseModel):
...
class TimeFromEvent(FhirBaseModel):
...
class Characteristic(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "definitionByTypeAndValue": {
            "class_name": "DefinitionByTypeAndValue",
            "is_contained": True,
        },
        "definitionByCombination": {
            "class_name": "DefinitionByCombination",
            "is_contained": True,
        },
    ...
    def __init__(
        ...
        definitionByTypeAndValue: "DefinitionByTypeAndValue" = None,
        definitionByCombination: "DefinitionByCombination" = None,
        instancesQuantity: "Quantity" = None,
        instancesRange: "Range" = None,
        durationQuantity: "Quantity" = None,
        durationRange: "Range" = None,
        timeFromEvent: list["TimeFromEvent"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
