...
class AssociatedParty(FhirBaseModel):
...
class ProgressStatus(FhirBaseModel):
...
class Recruitment(FhirBaseModel):
...
class ComparisonGroup(FhirBaseModel):
...
class OutcomeMeasure(FhirBaseModel):
...
class ResearchStudy(DomainResource):
    ...
    def __init__(
        ...
        classifier: list["CodeableConcept"] = None,
        associatedParty: list["AssociatedParty"] = None,
        progressStatus: list["ProgressStatus"] = None,
        whyStopped: "CodeableConcept" = None,
        recruitment: "Recruitment" = None,
        comparisonGroup: list["ComparisonGroup"] = None,
        objective: list["Objective"] = None,
        outcomeMeasure: list["OutcomeMeasure"] = None,
