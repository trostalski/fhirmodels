...
class ImageRegion2D(FhirBaseModel):
...
class ImageRegion3D(FhirBaseModel):
...
class Instance(FhirBaseModel):
    ...
    def __init__(
        ...
        imageRegion2D: list["ImageRegion2D"] = None,
        imageRegion3D: list["ImageRegion3D"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class ImagingSelection(DomainResource):
    ...
    def __init__(
        ...
        self.resourceType = "ImagingSelection"
