...
class ResultsByExposure(FhirBaseModel):
...
class PrecisionEstimate(FhirBaseModel):
...
class EffectEstimate(FhirBaseModel):
...
class CertaintySubcomponent(FhirBaseModel):
...
class EffectEvidenceSynthesis(DomainResource):
    ...
    def __init__(
        ...
        self.resourceType = "EffectEvidenceSynthesis"
