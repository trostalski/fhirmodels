...
from fhirmodels.models.R4.SubstanceAmount import *


class StartingMaterial(FhirBaseModel):
...
class MonomerSet(FhirBaseModel):
    """Todo.:param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
...
class DegreeOfPolymerisation(FhirBaseModel):
    """Todo.:param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
...
class StructuralRepresentation(FhirBaseModel):
    """Todo.:param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
    :param CodeableConcept type: Todo
...
class RepeatUnit(FhirBaseModel):
...
class SubstancePolymer(DomainResource):
    ...
    def __init__(
        ...
        self.resourceType = "SubstancePolymer"
