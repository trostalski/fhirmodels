...
from fhirmodels.models.R4B.BackboneElement import *
...
class AttributeEstimate(FhirBaseModel):
    ...
    def __init__(
        ...
        level: "float" = None,
        range: "Range" = None,
        attributeEstimate: list["AttributeEstimate"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Statistic(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "attributeEstimate": {"class_name": "AttributeEstimate", "is_contained": True},
        "modelCharacteristic": {
            "class_name": "ModelCharacteristic",
            "is_contained": True,
        },
    }
    ...
    def __init__(
        ...
        attributeEstimate: list["AttributeEstimate"] = None,
        modelCharacteristic: list["ModelCharacteristic"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Certainty(FhirBaseModel):
    ...
    def __init__(
        ...
        rater: "str" = None,
        subcomponent: list["Subcomponent"] = None,
    ):
        self.id = id
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Evidence(DomainResource):
    ...
    def __init__(
        ...
        assertion: "str" = None,
        note: list["Annotation"] = None,
        variableDefinition: list["VariableDefinition"] = None,
        synthesisType: "CodeableConcept" = None,
        studyType: "CodeableConcept" = None,
        statistic: list["Statistic"] = None,
