...
class ResourceTrigger(FhirBaseModel):
    ...
    def __init__(
        ...
        resource: "str" = None,
        supportedInteraction: list["str"] = None,
        queryCriteria: "QueryCriteria" = None,
...
class SubscriptionTopic(DomainResource):
    ...
    def __init__(
        ...
        resourceTrigger: list["ResourceTrigger"] = None,
        eventTrigger: list["EventTrigger"] = None,
        canFilterBy: list["CanFilterBy"] = None,
        notificationShape: list["NotificationShape"] = None,
    ):
