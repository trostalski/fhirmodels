...
class MolecularWeight(FhirBaseModel):
...
class Representation(FhirBaseModel):
    """ A depiction of the structure or characterization of the substance.:param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
    :param CodeableConcept type: The kind of structural representation (e.g. full, partial)
    :param str representation: The structural representation or characterization as a text string in a standard format
...
class Structure(FhirBaseModel):
    ...
    :param CodeableConcept stereochemistry: Stereochemistry type
    :param CodeableConcept opticalActivity: Optical activity type
    :param str molecularFormula: Molecular formula (e.g. using the Hill system)
    ...
    :param Representation representation: A depiction of the structure or characterization of the substance
    """
    # needed for complex properties where the element name is different from the class name
    property_class_info = {
...
class Relationship(FhirBaseModel):
...
class SourceMaterial(FhirBaseModel):
...
class SubstanceDefinition(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  version:  'str'  = None,  status:  'CodeableConcept'  = None,  classification:  list['CodeableConcept']  = None,  domain:  'CodeableConcept'  = None,  grade:  list['CodeableConcept']  = None,  description:  'str'  = None,  informationSource:  list['Reference']  = None,  note:  list['Annotation']  = None,  manufacturer:  list['Reference']  = None,  supplier:  list['Reference']  = None,  moiety:  list['Moiety']  = None,  property:  list['Property']  = None,  molecularWeight:  list['MolecularWeight']  = None,  structure:  'Structure'  = None,  code:  list['Code']  = None,  name:  list['Name']  = None,  relationship:  list['Relationship']  = None,  sourceMaterial:  'SourceMaterial'  = None, ):
        
        self.resourceType = "SubstanceDefinition"
