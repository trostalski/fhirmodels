...
class DataRequirement(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  type:  'str'  = None,  profile:  list['str']  = None,  subjectCodeableConcept:  'CodeableConcept'  = None,  subjectReference:  'Reference'  = None,  mustSupport:  list['str']  = None,  codeFilter:  list['CodeFilter']  = None,  dateFilter:  list['DateFilter']  = None,  limit:  'int'  = None,  sort:  list['Sort']  = None, ):
