...
class Activity(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "outcomeCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
