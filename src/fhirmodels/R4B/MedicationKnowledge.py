...
class RelatedMedicationKnowledge(FhirBaseModel):
...
class MonitoringProgram(FhirBaseModel):
...
class PatientCharacteristics(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "characteristicCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  characteristicCodeableConcept:  'CodeableConcept'  = None,  characteristicQuantity:  'Quantity'  = None,  value:  list['str']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class AdministrationGuidelines(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "indicationCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
        
        
        "indicationReference": {"class_name": "Reference", "is_contained": False},
        
        
        "patientCharacteristics": {"class_name": "PatientCharacteristics", "is_contained": True},
...
class MedicineClassification(FhirBaseModel):
...
class DrugCharacteristic(FhirBaseModel):
...
class Substitution(FhirBaseModel):
...
class MaxDispense(FhirBaseModel):
...
class Regulatory(FhirBaseModel):
...
class MedicationKnowledge(DomainResource):
    ...
    property_class_info = {
        ...
        "administrationGuidelines": {"class_name": "AdministrationGuidelines", "is_contained": True},
