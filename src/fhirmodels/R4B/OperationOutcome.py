...
class Issue(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  severity:  'str'  = None,  code:  'str'  = None,  details:  'CodeableConcept'  = None,  diagnostics:  'str'  = None,  location:  list['str']  = None,  expression:  list['str']  = None, ):
        self.id = id 
...
class OperationOutcome(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  issue:  list['Issue']  = None, ):
