...
class Endpoint(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  status:  'str'  = None,  connectionType:  'Coding'  = None,  name:  'str'  = None,  managingOrganization:  'Reference'  = None,  contact:  list['ContactPoint']  = None,  period:  'Period'  = None,  payloadType:  list['CodeableConcept']  = None,  payloadMimeType:  list['str']  = None,  address:  'str'  = None,  header:  list['str']  = None, ):
