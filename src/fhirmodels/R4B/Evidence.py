...
class VariableDefinition(FhirBaseModel):
...
class SampleSize(FhirBaseModel):
...
class AttributeEstimate(FhirBaseModel):
    ...
    :param CodeableConcept type: The type of attribute estimate, eg confidence interval or p value
    ...
    :param float level: Level of confidence interval, eg 0.95 for 95% confidence interval
...
class ModelCharacteristic(FhirBaseModel):
...
class Statistic(FhirBaseModel):
    ...
    :param Annotation note: Footnotes and/or explanatory notes
    :param CodeableConcept statisticType: Type of statistic, eg relative risk
...
class Evidence(DomainResource):
    ...
    :param str lastReviewDate: When the summary was last reviewed
    ...
    :param CodeableConcept studyType: The type of study that produced this evidence
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  url:  'str'  = None,  identifier:  list['Identifier']  = None,  version:  'str'  = None,  title:  'str'  = None,  citeAsReference:  'Reference'  = None,  citeAsMarkdown:  'str'  = None,  status:  'str'  = None,  date:  'str'  = None,  useContext:  list['UsageContext']  = None,  approvalDate:  'str'  = None,  lastReviewDate:  'str'  = None,  publisher:  'str'  = None,  contact:  list['ContactDetail']  = None,  author:  list['ContactDetail']  = None,  editor:  list['ContactDetail']  = None,  reviewer:  list['ContactDetail']  = None,  endorser:  list['ContactDetail']  = None,  relatedArtifact:  list['RelatedArtifact']  = None,  description:  'str'  = None,  assertion:  'str'  = None,  note:  list['Annotation']  = None,  variableDefinition:  list['VariableDefinition']  = None,  synthesisType:  'CodeableConcept'  = None,  studyType:  'CodeableConcept'  = None,  statistic:  list['Statistic']  = None,  certainty:  list['Certainty']  = None, ):
        
        self.resourceType = "Evidence"
