...
class SampledData(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  origin:  'Quantity'  = None,  period:  'float'  = None,  factor:  'float'  = None,  lowerLimit:  'float'  = None,  upperLimit:  'float'  = None,  dimensions:  'int'  = None,  data:  'str'  = None, ):
