...
class Repeat(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  boundsDuration:  'Duration'  = None,  boundsRange:  'Range'  = None,  boundsPeriod:  'Period'  = None,  count:  'int'  = None,  countMax:  'int'  = None,  duration:  'float'  = None,  durationMax:  'float'  = None,  durationUnit:  'str'  = None,  frequency:  'int'  = None,  frequencyMax:  'int'  = None,  period:  'float'  = None,  periodMax:  'float'  = None,  periodUnit:  'str'  = None,  dayOfWeek:  list['str']  = None,  timeOfDay:  list['str']  = None,  when:  list['str']  = None,  offset:  'int'  = None, ):
        self.id = id 
...
class Timing(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  event:  list['str']  = None,  repeat:  'Repeat'  = None,  code:  'CodeableConcept'  = None, ):
