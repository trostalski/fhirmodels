...
class ProdCharacteristic(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  height:  'Quantity'  = None,  width:  'Quantity'  = None,  depth:  'Quantity'  = None,  weight:  'Quantity'  = None,  nominalVolume:  'Quantity'  = None,  externalDiameter:  'Quantity'  = None,  shape:  'str'  = None,  color:  list['str']  = None,  imprint:  list['str']  = None,  image:  list['Attachment']  = None,  scoring:  'CodeableConcept'  = None, ):
