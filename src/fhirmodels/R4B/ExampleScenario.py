...
class ContainedInstance(FhirBaseModel):
...
class Operation(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  number:  'str'  = None,  type:  'str'  = None,  name:  'str'  = None,  initiator:  'str'  = None,  receiver:  'str'  = None,  description:  'str'  = None,  initiatorActive:  'bool'  = None,  receiverActive:  'bool'  = None,  request:  'Request'  = None,  response:  'Response'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.number = number 
...
class Alternative(FhirBaseModel):
...
class Step(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  process:  list['Process']  = None,  pause:  'bool'  = None,  operation:  'Operation'  = None,  alternative:  list['Alternative']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class ExampleScenario(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  url:  'str'  = None,  identifier:  list['Identifier']  = None,  version:  'str'  = None,  name:  'str'  = None,  status:  'str'  = None,  experimental:  'bool'  = None,  date:  'str'  = None,  publisher:  'str'  = None,  contact:  list['ContactDetail']  = None,  useContext:  list['UsageContext']  = None,  jurisdiction:  list['CodeableConcept']  = None,  copyright:  'str'  = None,  purpose:  'str'  = None,  actor:  list['Actor']  = None,  instance:  list['Instance']  = None,  process:  list['Process']  = None,  workflow:  list['str']  = None, ):
        
        self.resourceType = "ExampleScenario"
