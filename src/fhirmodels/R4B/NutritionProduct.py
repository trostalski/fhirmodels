...
class Instance(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  quantity:  'Quantity'  = None,  identifier:  list['Identifier']  = None,  lotNumber:  'str'  = None,  expiry:  'str'  = None,  useBy:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class NutritionProduct(DomainResource):
    ...
    property_class_info = {
        ...
        "productCharacteristic": {"class_name": "ProductCharacteristic", "is_contained": True},
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  status:  'str'  = None,  category:  list['CodeableConcept']  = None,  code:  'CodeableConcept'  = None,  manufacturer:  list['Reference']  = None,  nutrient:  list['Nutrient']  = None,  ingredient:  list['Ingredient']  = None,  knownAllergen:  list['CodeableReference']  = None,  productCharacteristic:  list['ProductCharacteristic']  = None,  instance:  'Instance'  = None,  note:  list['Annotation']  = None, ):
