...
class Agent(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  type:  'CodeableConcept'  = None,  role:  list['CodeableConcept']  = None,  who:  'Reference'  = None,  altId:  'str'  = None,  name:  'str'  = None,  requestor:  'bool'  = None,  location:  'Reference'  = None,  policy:  list['str']  = None,  media:  'Coding'  = None,  network:  'Network'  = None,  purposeOfUse:  list['CodeableConcept']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.type = type 
