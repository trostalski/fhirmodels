...
class RelatesTo(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  relationshipType:  'CodeableConcept'  = None,  targetClassifier:  list['CodeableConcept']  = None,  targetUri:  'str'  = None,  targetIdentifier:  'Identifier'  = None,  targetReference:  'Reference'  = None,  targetAttachment:  'Attachment'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class DateOfPublication(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  date:  'str'  = None,  year:  'str'  = None,  month:  'str'  = None,  day:  'str'  = None,  season:  'str'  = None,  text:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.date = date 
...
class PeriodicRelease(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  citedMedium:  'CodeableConcept'  = None,  volume:  'str'  = None,  issue:  'str'  = None,  dateOfPublication:  'DateOfPublication'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class WebLocation(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  type:  'CodeableConcept'  = None,  url:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.type = type 
...
class WhoClassified(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  person:  'Reference'  = None,  organization:  'Reference'  = None,  publisher:  'Reference'  = None,  classifierCopyright:  'str'  = None,  freeToShare:  'bool'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.person = person 
...
class Classification(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  type:  'CodeableConcept'  = None,  classifier:  list['CodeableConcept']  = None,  whoClassified:  'WhoClassified'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.type = type 
...
class AffiliationInfo(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  affiliation:  'str'  = None,  role:  'str'  = None,  identifier:  list['Identifier']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Entry(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  name:  'HumanName'  = None,  initials:  'str'  = None,  collectiveName:  'str'  = None,  identifier:  list['Identifier']  = None,  affiliationInfo:  list['AffiliationInfo']  = None,  address:  list['Address']  = None,  telecom:  list['ContactPoint']  = None,  contributionType:  list['CodeableConcept']  = None,  role:  'CodeableConcept'  = None,  contributionInstance:  list['ContributionInstance']  = None,  correspondingContact:  'bool'  = None,  listOrder:  'int'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.name = name 
