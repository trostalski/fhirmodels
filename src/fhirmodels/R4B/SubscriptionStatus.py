...
class NotificationEvent(FhirBaseModel):
    ...
    :param str eventNumber: Event number
    :param str timestamp: The instant this event occurred
    :param Reference focus: The focus of this event
    :param Reference additionalContext: Additional context for this event
    """
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  eventNumber:  'str'  = None,  timestamp:  'str'  = None,  focus:  'Reference'  = None,  additionalContext:  list['Reference']  = None, ):
        self.id = id 
...
class SubscriptionStatus(DomainResource):
    ...
    :param str eventsSinceSubscriptionStart: Events since the Subscription was created
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  status:  'str'  = None,  type:  'str'  = None,  eventsSinceSubscriptionStart:  'str'  = None,  notificationEvent:  list['NotificationEvent']  = None,  subscription:  'Reference'  = None,  topic:  'str'  = None,  error:  list['CodeableConcept']  = None, ):
        
        self.resourceType = "SubscriptionStatus"
