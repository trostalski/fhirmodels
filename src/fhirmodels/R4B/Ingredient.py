...
class ReferenceStrength(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  substance:  'CodeableReference'  = None,  strengthRatio:  'Ratio'  = None,  strengthRatioRange:  'RatioRange'  = None,  measurementPoint:  'str'  = None,  country:  list['CodeableConcept']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Strength(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  presentationRatio:  'Ratio'  = None,  presentationRatioRange:  'RatioRange'  = None,  textPresentation:  'str'  = None,  concentrationRatio:  'Ratio'  = None,  concentrationRatioRange:  'RatioRange'  = None,  textConcentration:  'str'  = None,  measurementPoint:  'str'  = None,  country:  list['CodeableConcept']  = None,  referenceStrength:  list['ReferenceStrength']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
