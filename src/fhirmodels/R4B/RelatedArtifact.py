...
class RelatedArtifact(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  type:  'str'  = None,  label:  'str'  = None,  display:  'str'  = None,  citation:  'str'  = None,  url:  'str'  = None,  document:  'Attachment'  = None,  resource:  'str'  = None, ):
