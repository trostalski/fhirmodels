...
class Package(FhirBaseModel):
    ...
    def __init__(self,  packageFor:  list['Reference']  = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  type:  'CodeableConcept'  = None,  quantity:  'int'  = None,  material:  list['CodeableConcept']  = None,  alternateMaterial:  list['CodeableConcept']  = None,  shelfLifeStorage:  list['ShelfLifeStorage']  = None,  manufacturer:  list['Reference']  = None,  property:  list['Property']  = None,  containedItem:  list['ContainedItem']  = None,  package:  list['Package']  = None, ):
...
class PackagedProductDefinition(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  name:  'str'  = None,  type:  'CodeableConcept'  = None,  packageFor:  list['Reference']  = None,  status:  'CodeableConcept'  = None,  statusDate:  'str'  = None,  containedItemQuantity:  list['Quantity']  = None,  description:  'str'  = None,  legalStatusOfSupply:  list['LegalStatusOfSupply']  = None,  marketingStatus:  list['MarketingStatus']  = None,  characteristic:  list['CodeableConcept']  = None,  copackagedIndicator:  'bool'  = None,  manufacturer:  list['Reference']  = None,  package:  'Package'  = None, ):
