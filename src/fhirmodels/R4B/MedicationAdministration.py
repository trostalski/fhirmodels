...
class MedicationAdministration(DomainResource):
    ...
    property_class_info = {
        ...
        "medicationCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
