...
class Bundle(DomainResource):
    ...
    property_class_info = {
        ...
        "issues": {"class_name": "Resource", "is_contained": False},
        
        }
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  identifier:  'Identifier'  = None,  type:  'str'  = None,  timestamp:  'str'  = None,  total:  'int'  = None,  link:  list['Link']  = None,  entry:  list['Entry']  = None,  signature:  'Signature'  = None,  issues:  'Resource'  = None, ):
