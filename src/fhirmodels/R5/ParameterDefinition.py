...
class ParameterDefinition(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  name:  'str'  = None,  use:  'str'  = None,  min:  'int'  = None,  max:  'str'  = None,  documentation:  'str'  = None,  type:  'str'  = None,  profile:  'str'  = None, ):
