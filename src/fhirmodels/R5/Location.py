...
class Location(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  status:  'str'  = None,  operationalStatus:  'Coding'  = None,  name:  'str'  = None,  alias:  list['str']  = None,  description:  'str'  = None,  mode:  'str'  = None,  type:  list['CodeableConcept']  = None,  contact:  list['ExtendedContactDetail']  = None,  address:  'Address'  = None,  form:  'CodeableConcept'  = None,  position:  'Position'  = None,  managingOrganization:  'Reference'  = None,  partOf:  'Reference'  = None,  characteristic:  list['CodeableConcept']  = None,  hoursOfOperation:  list['Availability']  = None,  virtualService:  list['VirtualServiceDetail']  = None,  endpoint:  list['Reference']  = None, ):
