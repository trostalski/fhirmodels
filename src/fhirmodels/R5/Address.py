...
The ISO21090-codedString may be used to provide a coded representation of the contents of strings in an Address.
    ...
    :param str country: Country (e.g. may be ISO 3166 2 or 3 letter code)
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  use:  'str'  = None,  type:  'str'  = None,  text:  'str'  = None,  line:  list['str']  = None,  city:  'str'  = None,  district:  'str'  = None,  state:  'str'  = None,  postalCode:  'str'  = None,  country:  'str'  = None,  period:  'Period'  = None, ):
