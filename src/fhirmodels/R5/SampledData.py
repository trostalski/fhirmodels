...
class SampledData(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  origin:  'Quantity'  = None,  interval:  'float'  = None,  intervalUnit:  'str'  = None,  factor:  'float'  = None,  lowerLimit:  'float'  = None,  upperLimit:  'float'  = None,  dimensions:  'int'  = None,  codeMap:  'str'  = None,  offsets:  'str'  = None,  data:  'str'  = None, ):
