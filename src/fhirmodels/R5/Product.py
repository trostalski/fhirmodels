...
class Product(FhirBaseModel):
    ...
    def __init__(self,  status:  'str'  = None,  category:  list['CodeableConcept']  = None,  code:  'CodeableConcept'  = None,  manufacturer:  list['Reference']  = None,  instance:  'Instance'  = None,  note:  list['Annotation']  = None, ):
