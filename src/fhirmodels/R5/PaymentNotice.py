...
class PaymentNotice(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  status:  'str'  = None,  request:  'Reference'  = None,  response:  'Reference'  = None,  created:  'str'  = None,  reporter:  'Reference'  = None,  payment:  'Reference'  = None,  paymentDate:  'str'  = None,  payee:  'Reference'  = None,  recipient:  'Reference'  = None,  amount:  'Money'  = None,  paymentStatus:  'CodeableConcept'  = None, ):
