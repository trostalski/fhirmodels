...
class Software(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  name:  'str'  = None,  version:  'str'  = None,  releaseDate:  'str'  = None, ):
        self.id = id 
...
class Implementation(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  description:  'str'  = None,  url:  'str'  = None,  custodian:  'Reference'  = None,  implementationGuide:  list['str']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Security(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  cors:  'bool'  = None,  service:  list['CodeableConcept']  = None,  description:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.cors = cors 
...
class Interaction(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  code:  'str'  = None,  documentation:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.code = code 
...
class SearchParam(FhirBaseModel):
    ...
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
    :param str name: Name for parameter in search url
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  name:  'str'  = None,  definition:  'str'  = None,  type:  'str'  = None,  documentation:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.name = name 
...
class Operation(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  name:  'str'  = None,  definition:  'str'  = None,  documentation:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.name = name 
...
class Resource(FhirBaseModel):
    ...
    :param str profile: System-wide profile
    :param str supportedProfile: Use-case specific profiles
    ...
    :param bool conditionalPatch: If allows/uses conditional patch
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  type:  'str'  = None,  profile:  'str'  = None,  supportedProfile:  list['str']  = None,  documentation:  'str'  = None,  interaction:  list['Interaction']  = None,  versioning:  'str'  = None,  readHistory:  'bool'  = None,  updateCreate:  'bool'  = None,  conditionalCreate:  'bool'  = None,  conditionalRead:  'str'  = None,  conditionalUpdate:  'bool'  = None,  conditionalPatch:  'bool'  = None,  conditionalDelete:  'str'  = None,  referencePolicy:  list['str']  = None,  searchInclude:  list['str']  = None,  searchRevInclude:  list['str']  = None,  searchParam:  list['SearchParam']  = None,  operation:  list['Operation']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.type = type 
...
class Rest(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  mode:  'str'  = None,  documentation:  'str'  = None,  security:  'Security'  = None,  resource:  list['Resource']  = None,  interaction:  list['Interaction']  = None,  searchParam:  list['SearchParam']  = None,  operation:  list['Operation']  = None,  compartment:  list['str']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.mode = mode 
...
class Endpoint(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  protocol:  'Coding'  = None,  address:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class SupportedMessage(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  mode:  'str'  = None,  definition:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.mode = mode 
...
class Messaging(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  endpoint:  list['Endpoint']  = None,  reliableCache:  'int'  = None,  documentation:  'str'  = None,  supportedMessage:  list['SupportedMessage']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Document(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  mode:  'str'  = None,  documentation:  'str'  = None,  profile:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.mode = mode 
...
class CapabilityStatement(DomainResource):
    ...
    :param Identifier identifier: Additional identifier for the CapabilityStatement (business identifier)
    ...
    :param str acceptLanguage: Languages supported
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  url:  'str'  = None,  identifier:  list['Identifier']  = None,  version:  'str'  = None,  versionAlgorithmString:  'str'  = None,  versionAlgorithmCoding:  'Coding'  = None,  name:  'str'  = None,  title:  'str'  = None,  status:  'str'  = None,  experimental:  'bool'  = None,  date:  'str'  = None,  publisher:  'str'  = None,  contact:  list['ContactDetail']  = None,  description:  'str'  = None,  useContext:  list['UsageContext']  = None,  jurisdiction:  list['CodeableConcept']  = None,  purpose:  'str'  = None,  copyright:  'str'  = None,  copyrightLabel:  'str'  = None,  kind:  'str'  = None,  instantiates:  list['str']  = None,  imports:  list['str']  = None,  software:  'Software'  = None,  implementation:  'Implementation'  = None,  fhirVersion:  'str'  = None,  format:  list['str']  = None,  patchFormat:  list['str']  = None,  acceptLanguage:  list['str']  = None,  rest:  list['Rest']  = None,  messaging:  list['Messaging']  = None,  document:  list['Document']  = None, ):
        ...
        self.acceptLanguage = acceptLanguage or []
        self.rest = rest or []
