...
class TriggeredBy(FhirBaseModel):
    """ Identifies the observation(s) that triggered the performance of this observation.:param str id: Unique id for inter-element referencing
    ...
    property_class_info = {
        ...
        "observation": {"class_name": "Reference", "is_contained": False},
        
        
        
        }
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  observation:  'Reference'  = None,  type:  'str'  = None,  reason:  'str'  = None, ):
        self.id = id 
...
class ReferenceRange(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "normalValue": {"class_name": "CodeableConcept", "is_contained": False},
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  low:  'Quantity'  = None,  high:  'Quantity'  = None,  normalValue:  'CodeableConcept'  = None,  type:  'CodeableConcept'  = None,  appliesTo:  list['CodeableConcept']  = None,  age:  'Range'  = None,  text:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.low = low 
...
class Component(FhirBaseModel):
    ...
    :param Attachment valueAttachment: Actual component result
    :param Reference valueReference: Actual component result
...
class Observation(DomainResource):
    ...
    :param Reference instantiatesReference: Instantiates FHIR ObservationDefinition
    :param Reference basedOn: Fulfills plan, proposal or order
    :param TriggeredBy triggeredBy: Triggering observation(s)
    ...
    :param Attachment valueAttachment: Actual result
    :param Reference valueReference: Actual result
    ...
    property_class_info = {
        ...
        "instantiatesReference": {"class_name": "Reference", "is_contained": False},
        
        
        "basedOn": {"class_name": "Reference", "is_contained": False},
        
        
        "triggeredBy": {"class_name": "TriggeredBy", "is_contained": True},
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  instantiatesCanonical:  'str'  = None,  instantiatesReference:  'Reference'  = None,  basedOn:  list['Reference']  = None,  triggeredBy:  list['TriggeredBy']  = None,  partOf:  list['Reference']  = None,  status:  'str'  = None,  category:  list['CodeableConcept']  = None,  code:  'CodeableConcept'  = None,  subject:  'Reference'  = None,  focus:  list['Reference']  = None,  encounter:  'Reference'  = None,  effectiveDateTime:  'str'  = None,  effectivePeriod:  'Period'  = None,  effectiveTiming:  'Timing'  = None,  effectiveInstant:  'str'  = None,  issued:  'str'  = None,  performer:  list['Reference']  = None,  valueQuantity:  'Quantity'  = None,  valueCodeableConcept:  'CodeableConcept'  = None,  valueString:  'str'  = None,  valueBoolean:  'bool'  = None,  valueInteger:  'int'  = None,  valueRange:  'Range'  = None,  valueRatio:  'Ratio'  = None,  valueSampledData:  'SampledData'  = None,  valueTime:  'str'  = None,  valueDateTime:  'str'  = None,  valuePeriod:  'Period'  = None,  valueAttachment:  'Attachment'  = None,  valueReference:  'Reference'  = None,  dataAbsentReason:  'CodeableConcept'  = None,  interpretation:  list['CodeableConcept']  = None,  note:  list['Annotation']  = None,  bodySite:  'CodeableConcept'  = None,  bodyStructure:  'Reference'  = None,  method:  'CodeableConcept'  = None,  specimen:  'Reference'  = None,  device:  'Reference'  = None,  referenceRange:  list['ReferenceRange']  = None,  hasMember:  list['Reference']  = None,  derivedFrom:  list['Reference']  = None,  component:  list['Component']  = None, ):
        ...
        self.instantiatesReference = instantiatesReference 
        self.basedOn = basedOn or []
        self.triggeredBy = triggeredBy or []
