...
class DependsOn(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  uri:  'str'  = None,  packageId:  'str'  = None,  version:  'str'  = None,  reason:  'str'  = None, ):
        self.id = id 
...
class Resource(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  reference:  'Reference'  = None,  fhirVersion:  list['str']  = None,  name:  'str'  = None,  description:  'str'  = None,  isExample:  'bool'  = None,  profile:  list['str']  = None,  groupingId:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Page(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  sourceUrl:  'str'  = None,  sourceString:  'str'  = None,  sourceMarkdown:  'str'  = None,  name:  'str'  = None,  title:  'str'  = None,  generation:  'str'  = None,  page:  list['Page']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Parameter(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  code:  'Coding'  = None,  value:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.code = code 
...
class Resource(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  reference:  'Reference'  = None,  isExample:  'bool'  = None,  profile:  list['str']  = None,  relativePath:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.reference = reference 
...
class Page(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  name:  'str'  = None,  title:  'str'  = None,  anchor:  list['str']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.name = name 
...
class Manifest(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  rendering:  'str'  = None,  resource:  list['Resource']  = None,  page:  list['Page']  = None,  image:  list['str']  = None,  other:  list['str']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
