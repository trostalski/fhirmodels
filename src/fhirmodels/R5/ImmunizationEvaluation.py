...
class ImmunizationEvaluation(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  status:  'str'  = None,  patient:  'Reference'  = None,  date:  'str'  = None,  authority:  'Reference'  = None,  targetDisease:  'CodeableConcept'  = None,  immunizationEvent:  'Reference'  = None,  doseStatus:  'CodeableConcept'  = None,  doseStatusReason:  list['CodeableConcept']  = None,  description:  'str'  = None,  series:  'str'  = None,  doseNumber:  'str'  = None,  seriesDoses:  'str'  = None, ):
        
        self.resourceType = "ImmunizationEvaluation"
