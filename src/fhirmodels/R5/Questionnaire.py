...
class EnableWhen(FhirBaseModel):
    ...
    :param str question: The linkId of question that determines whether item is enabled/disabled
...
class AnswerOption(FhirBaseModel):
    """ One of the permitted answers for the question.:param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
...
class Item(FhirBaseModel):
    ...
    :param str disabledDisplay: hidden | protected
    ...
    :param int maxLength: No more than these many characters
    :param str answerConstraint: optionsOnly | optionsOrType | optionsOrString
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  linkId:  'str'  = None,  definition:  'str'  = None,  code:  list['Coding']  = None,  prefix:  'str'  = None,  text:  'str'  = None,  type:  'str'  = None,  enableWhen:  list['EnableWhen']  = None,  enableBehavior:  'str'  = None,  disabledDisplay:  'str'  = None,  required:  'bool'  = None,  repeats:  'bool'  = None,  readOnly:  'bool'  = None,  maxLength:  'int'  = None,  answerConstraint:  'str'  = None,  answerValueSet:  'str'  = None,  answerOption:  list['AnswerOption']  = None,  initial:  list['Initial']  = None,  item:  list['Item']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.linkId = linkId 
...
class Questionnaire(DomainResource):
    ...
    :param str url: Canonical identifier for this questionnaire, represented as an absolute URI (globally unique)
    :param Identifier identifier: Business identifier for questionnaire
    ...
    :param str derivedFrom: Based on Questionnaire
    ...
    :param str lastReviewDate: When the questionnaire was last reviewed by the publisher
