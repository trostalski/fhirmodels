...
class DateCriterion(FhirBaseModel):
...
class Recommendation(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  vaccineCode:  list['CodeableConcept']  = None,  targetDisease:  list['CodeableConcept']  = None,  contraindicatedVaccineCode:  list['CodeableConcept']  = None,  forecastStatus:  'CodeableConcept'  = None,  forecastReason:  list['CodeableConcept']  = None,  dateCriterion:  list['DateCriterion']  = None,  description:  'str'  = None,  series:  'str'  = None,  doseNumber:  'str'  = None,  seriesDoses:  'str'  = None,  supportingImmunization:  list['Reference']  = None,  supportingPatientInformation:  list['Reference']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
