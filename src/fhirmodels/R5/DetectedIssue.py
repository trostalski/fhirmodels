...
class Mitigation(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  action:  'CodeableConcept'  = None,  date:  'str'  = None,  author:  'Reference'  = None,  note:  list['Annotation']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.action = action 
...
class DetectedIssue(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  status:  'str'  = None,  category:  list['CodeableConcept']  = None,  code:  'CodeableConcept'  = None,  severity:  'str'  = None,  subject:  'Reference'  = None,  encounter:  'Reference'  = None,  identifiedDateTime:  'str'  = None,  identifiedPeriod:  'Period'  = None,  author:  'Reference'  = None,  implicated:  list['Reference']  = None,  evidence:  list['Evidence']  = None,  detail:  'str'  = None,  reference:  'str'  = None,  mitigation:  list['Mitigation']  = None, ):
