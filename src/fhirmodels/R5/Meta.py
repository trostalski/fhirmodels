...
class Meta(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  versionId:  'str'  = None,  lastUpdated:  'str'  = None,  source:  'str'  = None,  profile:  list['str']  = None,  security:  list['Coding']  = None,  tag:  list['Coding']  = None, ):
