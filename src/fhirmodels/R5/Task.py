...
class Performer(FhirBaseModel):
    """ The entity who performed the requested task.:param str id: Unique id for inter-element referencing
...
class Input(FhirBaseModel):
    ...
    :param int valueInteger64: Content to use in performing the task
    ...
    :param CodeableReference valueCodeableReference: Content to use in performing the task
    ...
    :param RatioRange valueRatioRange: Content to use in performing the task
    ...
    :param Availability valueAvailability: Content to use in performing the task
    :param ExtendedContactDetail valueExtendedContactDetail: Content to use in performing the task
...
class Task(DomainResource):
    ...
    :param Performer performer: Who or what performed the task
    ...
    property_class_info = {
        ...
        "requestedPerformer": {"class_name": "CodeableReference", "is_contained": False},
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  instantiatesCanonical:  'str'  = None,  instantiatesUri:  'str'  = None,  basedOn:  list['Reference']  = None,  groupIdentifier:  'Identifier'  = None,  partOf:  list['Reference']  = None,  status:  'str'  = None,  statusReason:  'CodeableReference'  = None,  businessStatus:  'CodeableConcept'  = None,  intent:  'str'  = None,  priority:  'str'  = None,  doNotPerform:  'bool'  = None,  code:  'CodeableConcept'  = None,  description:  'str'  = None,  focus:  'Reference'  = None,  _for:  'Reference'  = None,  encounter:  'Reference'  = None,  requestedPeriod:  'Period'  = None,  executionPeriod:  'Period'  = None,  authoredOn:  'str'  = None,  lastModified:  'str'  = None,  requester:  'Reference'  = None,  requestedPerformer:  list['CodeableReference']  = None,  owner:  'Reference'  = None,  performer:  list['Performer']  = None,  location:  'Reference'  = None,  reason:  list['CodeableReference']  = None,  insurance:  list['Reference']  = None,  note:  list['Annotation']  = None,  relevantHistory:  list['Reference']  = None,  restriction:  'Restriction'  = None,  input:  list['Input']  = None,  output:  list['Output']  = None, ):
        ...
        self.requestedPerformer = requestedPerformer or []
        self.owner = owner 
