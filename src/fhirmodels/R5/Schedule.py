...
class Schedule(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  active:  'bool'  = None,  serviceCategory:  list['CodeableConcept']  = None,  serviceType:  list['CodeableReference']  = None,  specialty:  list['CodeableConcept']  = None,  name:  'str'  = None,  actor:  list['Reference']  = None,  planningHorizon:  'Period'  = None,  comment:  'str'  = None, ):
