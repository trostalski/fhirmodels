...
class Insurance(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  sequence:  'int'  = None,  focal:  'bool'  = None,  identifier:  'Identifier'  = None,  coverage:  'Reference'  = None,  businessArrangement:  'str'  = None,  preAuthRef:  list['str']  = None,  claimResponse:  'Reference'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.sequence = sequence 
...
class SubDetail(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  sequence:  'int'  = None,  traceNumber:  list['Identifier']  = None,  revenue:  'CodeableConcept'  = None,  category:  'CodeableConcept'  = None,  productOrService:  'CodeableConcept'  = None,  productOrServiceEnd:  'CodeableConcept'  = None,  modifier:  list['CodeableConcept']  = None,  programCode:  list['CodeableConcept']  = None,  patientPaid:  'Money'  = None,  quantity:  'Quantity'  = None,  unitPrice:  'Money'  = None,  factor:  'float'  = None,  tax:  'Money'  = None,  net:  'Money'  = None,  udi:  list['Reference']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.sequence = sequence 
...
class Detail(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  sequence:  'int'  = None,  traceNumber:  list['Identifier']  = None,  revenue:  'CodeableConcept'  = None,  category:  'CodeableConcept'  = None,  productOrService:  'CodeableConcept'  = None,  productOrServiceEnd:  'CodeableConcept'  = None,  modifier:  list['CodeableConcept']  = None,  programCode:  list['CodeableConcept']  = None,  patientPaid:  'Money'  = None,  quantity:  'Quantity'  = None,  unitPrice:  'Money'  = None,  factor:  'float'  = None,  tax:  'Money'  = None,  net:  'Money'  = None,  udi:  list['Reference']  = None,  subDetail:  list['SubDetail']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.sequence = sequence 
...
class Item(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  sequence:  'int'  = None,  traceNumber:  list['Identifier']  = None,  careTeamSequence:  list['int']  = None,  diagnosisSequence:  list['int']  = None,  procedureSequence:  list['int']  = None,  informationSequence:  list['int']  = None,  revenue:  'CodeableConcept'  = None,  category:  'CodeableConcept'  = None,  productOrService:  'CodeableConcept'  = None,  productOrServiceEnd:  'CodeableConcept'  = None,  request:  list['Reference']  = None,  modifier:  list['CodeableConcept']  = None,  programCode:  list['CodeableConcept']  = None,  servicedDate:  'str'  = None,  servicedPeriod:  'Period'  = None,  locationCodeableConcept:  'CodeableConcept'  = None,  locationAddress:  'Address'  = None,  locationReference:  'Reference'  = None,  patientPaid:  'Money'  = None,  quantity:  'Quantity'  = None,  unitPrice:  'Money'  = None,  factor:  'float'  = None,  tax:  'Money'  = None,  net:  'Money'  = None,  udi:  list['Reference']  = None,  bodySite:  list['BodySite']  = None,  encounter:  list['Reference']  = None,  detail:  list['Detail']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.sequence = sequence 
...
class Claim(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  traceNumber:  list['Identifier']  = None,  status:  'str'  = None,  type:  'CodeableConcept'  = None,  subType:  'CodeableConcept'  = None,  use:  'str'  = None,  patient:  'Reference'  = None,  billablePeriod:  'Period'  = None,  created:  'str'  = None,  enterer:  'Reference'  = None,  insurer:  'Reference'  = None,  provider:  'Reference'  = None,  priority:  'CodeableConcept'  = None,  fundsReserve:  'CodeableConcept'  = None,  related:  list['Related']  = None,  prescription:  'Reference'  = None,  originalPrescription:  'Reference'  = None,  payee:  'Payee'  = None,  referral:  'Reference'  = None,  encounter:  list['Reference']  = None,  facility:  'Reference'  = None,  diagnosisRelatedGroup:  'CodeableConcept'  = None,  event:  list['Event']  = None,  careTeam:  list['CareTeam']  = None,  supportingInfo:  list['SupportingInfo']  = None,  diagnosis:  list['Diagnosis']  = None,  procedure:  list['Procedure']  = None,  insurance:  list['Insurance']  = None,  accident:  'Accident'  = None,  patientPaid:  'Money'  = None,  item:  list['Item']  = None,  total:  'Money'  = None, ):
