...
class Origin(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  index:  'int'  = None,  profile:  'Coding'  = None,  url:  'str'  = None, ):
        self.id = id 
...
class Capability(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  required:  'bool'  = None,  validated:  'bool'  = None,  description:  'str'  = None,  origin:  list['int']  = None,  destination:  'int'  = None,  link:  list['str']  = None,  capabilities:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Scope(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  artifact:  'str'  = None,  conformance:  'CodeableConcept'  = None,  phase:  'CodeableConcept'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Requirement(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  linkUri:  'str'  = None,  linkCanonical:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class _assert(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  label:  'str'  = None,  description:  'str'  = None,  direction:  'str'  = None,  compareToSourceId:  'str'  = None,  compareToSourceExpression:  'str'  = None,  compareToSourcePath:  'str'  = None,  contentType:  'str'  = None,  defaultManualCompletion:  'str'  = None,  expression:  'str'  = None,  headerField:  'str'  = None,  minimumId:  'str'  = None,  navigationLinks:  'bool'  = None,  operator:  'str'  = None,  path:  'str'  = None,  requestMethod:  'str'  = None,  requestURL:  'str'  = None,  resource:  'str'  = None,  response:  'str'  = None,  responseCode:  'str'  = None,  sourceId:  'str'  = None,  stopTestOnFail:  'bool'  = None,  validateProfileId:  'str'  = None,  value:  'str'  = None,  warningOnly:  'bool'  = None,  requirement:  list['Requirement']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.label = label 
...
class Action(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  operation:  'Operation'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.operation = operation 
