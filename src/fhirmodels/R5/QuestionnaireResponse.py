...
class Answer(FhirBaseModel):
    ...
    :param Item item: Child items of question
    """
...
class Item(FhirBaseModel):
    ...
    :param Item item: Child items of group item
    """
    # needed for complex properties where the element name is different from the class name
    property_class_info = {
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  linkId:  'str'  = None,  definition:  'str'  = None,  text:  'str'  = None,  answer:  list['Answer']  = None,  item:  list['Item']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.linkId = linkId 
