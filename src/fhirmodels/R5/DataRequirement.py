...
class ValueFilter(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  path:  'str'  = None,  searchParam:  'str'  = None,  comparator:  'str'  = None,  valueDateTime:  'str'  = None,  valuePeriod:  'Period'  = None,  valueDuration:  'Duration'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.path = path 
        self.searchParam = searchParam 
...
class DataRequirement(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  type:  'str'  = None,  profile:  list['str']  = None,  subjectCodeableConcept:  'CodeableConcept'  = None,  subjectReference:  'Reference'  = None,  mustSupport:  list['str']  = None,  codeFilter:  list['CodeFilter']  = None,  dateFilter:  list['DateFilter']  = None,  valueFilter:  list['ValueFilter']  = None,  limit:  'int'  = None,  sort:  list['Sort']  = None, ):
