...
class ContentDefinition(FhirBaseModel):
    ...
    :param str publicationStatus: amended | appended | cancelled | disputed | entered-in-error | executable +
...
class SecurityLabel(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  number:  list['int']  = None,  classification:  'Coding'  = None,  category:  list['Coding']  = None,  control:  list['Coding']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Offer(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  party:  list['Party']  = None,  topic:  'Reference'  = None,  type:  'CodeableConcept'  = None,  decision:  'CodeableConcept'  = None,  decisionMode:  list['CodeableConcept']  = None,  answer:  list['Answer']  = None,  text:  'str'  = None,  linkId:  list['str']  = None,  securityLabelNumber:  list['int']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class ValuedItem(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "entityCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
...
class Asset(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  scope:  'CodeableConcept'  = None,  type:  list['CodeableConcept']  = None,  typeReference:  list['Reference']  = None,  subtype:  list['CodeableConcept']  = None,  relationship:  'Coding'  = None,  context:  list['Context']  = None,  condition:  'str'  = None,  periodType:  list['CodeableConcept']  = None,  period:  list['Period']  = None,  usePeriod:  list['Period']  = None,  text:  'str'  = None,  linkId:  list['str']  = None,  answer:  list['Answer']  = None,  securityLabelNumber:  list['int']  = None,  valuedItem:  list['ValuedItem']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.scope = scope 
...
class Action(FhirBaseModel):
    ...
    :param CodeableReference reason: Why is action (not) needed?
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  doNotPerform:  'bool'  = None,  type:  'CodeableConcept'  = None,  subject:  list['Subject']  = None,  intent:  'CodeableConcept'  = None,  linkId:  list['str']  = None,  status:  'CodeableConcept'  = None,  context:  'Reference'  = None,  contextLinkId:  list['str']  = None,  occurrenceDateTime:  'str'  = None,  occurrencePeriod:  'Period'  = None,  occurrenceTiming:  'Timing'  = None,  requester:  list['Reference']  = None,  requesterLinkId:  list['str']  = None,  performerType:  list['CodeableConcept']  = None,  performerRole:  'CodeableConcept'  = None,  performer:  'Reference'  = None,  performerLinkId:  list['str']  = None,  reason:  list['CodeableReference']  = None,  reasonLinkId:  list['str']  = None,  note:  list['Annotation']  = None,  securityLabelNumber:  list['int']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Term(FhirBaseModel):
    ...
    property_class_info = {
        ...
        "topicCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  'Identifier'  = None,  issued:  'str'  = None,  applies:  'Period'  = None,  topicCodeableConcept:  'CodeableConcept'  = None,  topicReference:  'Reference'  = None,  type:  'CodeableConcept'  = None,  subType:  'CodeableConcept'  = None,  text:  'str'  = None,  securityLabel:  list['SecurityLabel']  = None,  offer:  'Offer'  = None,  asset:  list['Asset']  = None,  action:  list['Action']  = None,  group:  list['Group']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.identifier = identifier 
...
class Contract(DomainResource):
    ...
    :param str status: amended | appended | cancelled | disputed | entered-in-error | executable +
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  url:  'str'  = None,  version:  'str'  = None,  status:  'str'  = None,  legalState:  'CodeableConcept'  = None,  instantiatesCanonical:  'Reference'  = None,  instantiatesUri:  'str'  = None,  contentDerivative:  'CodeableConcept'  = None,  issued:  'str'  = None,  applies:  'Period'  = None,  expirationType:  'CodeableConcept'  = None,  subject:  list['Reference']  = None,  authority:  list['Reference']  = None,  domain:  list['Reference']  = None,  site:  list['Reference']  = None,  name:  'str'  = None,  title:  'str'  = None,  subtitle:  'str'  = None,  alias:  list['str']  = None,  author:  'Reference'  = None,  scope:  'CodeableConcept'  = None,  topicCodeableConcept:  'CodeableConcept'  = None,  topicReference:  'Reference'  = None,  type:  'CodeableConcept'  = None,  subType:  list['CodeableConcept']  = None,  contentDefinition:  'ContentDefinition'  = None,  term:  list['Term']  = None,  supportingInfo:  list['Reference']  = None,  relevantHistory:  list['Reference']  = None,  signer:  list['Signer']  = None,  friendly:  list['Friendly']  = None,  legal:  list['Legal']  = None,  rule:  list['Rule']  = None, ):
