...
class InsurancePlan(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  status:  'str'  = None,  type:  list['CodeableConcept']  = None,  name:  'str'  = None,  alias:  list['str']  = None,  period:  'Period'  = None,  ownedBy:  'Reference'  = None,  administeredBy:  'Reference'  = None,  coverageArea:  list['Reference']  = None,  contact:  list['ExtendedContactDetail']  = None,  endpoint:  list['Reference']  = None,  network:  list['Reference']  = None,  coverage:  list['Coverage']  = None,  plan:  list['Plan']  = None, ):
