...
from fhirmodels.R5.Count import *
from fhirmodels.R5.DataRequirement import *
from fhirmodels.R5.Distance import *
from fhirmodels.R5.Dosage import *
...
from fhirmodels.R5.RatioRange import *
from fhirmodels.R5.Reference import *
from fhirmodels.R5.RelatedArtifact import *
from fhirmodels.R5.SampledData import *
from fhirmodels.R5.Signature import *
from fhirmodels.R5.Timing import *
from fhirmodels.R5.TriggerDefinition import *
...
class Discriminator(FhirBaseModel):
    ...
    :param str type: value | exists | type | profile | position
...
class Type(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  code:  'str'  = None,  profile:  list['str']  = None,  targetProfile:  list['str']  = None,  aggregation:  list['str']  = None,  versioning:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.code = code 
...
class Example(FhirBaseModel):
    ...
    :param int valueInteger64: Value of Example (one of allowed types)
    ...
    :param CodeableReference valueCodeableReference: Value of Example (one of allowed types)
    ...
    :param RatioRange valueRatioRange: Value of Example (one of allowed types)
    ...
    :param Availability valueAvailability: Value of Example (one of allowed types)
    :param ExtendedContactDetail valueExtendedContactDetail: Value of Example (one of allowed types)
...
class Constraint(FhirBaseModel):
    ...
    :param bool suppress: Suppress warning or hint in profile
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  key:  'str'  = None,  requirements:  'str'  = None,  severity:  'str'  = None,  suppress:  'bool'  = None,  human:  'str'  = None,  expression:  'str'  = None,  source:  'str'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.key = key 
...
class Additional(FhirBaseModel):
    """ Additional bindings that help applications implementing this element. Additional bindings do not replace the main binding but provide more information and/or context.:param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param str purpose: maximum | minimum | required | extensible | candidate | current | preferred | ui | starter | component
    :param str valueSet: The value set for the additional binding
    :param str documentation: Documentation of the purpose of use of the binding
    :param str shortDoco: Concise documentation - for summary tables
    :param UsageContext usage: Qualifies the usage - jurisdiction, gender, workflow status etc.
    :param bool any: Whether binding can applies to all repeats, or just one
    """
    # needed for complex properties where the element name is different from the class name
    property_class_info = {
        ...
        "usage": {"class_name": "UsageContext", "is_contained": False},
        
        
        }
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  purpose:  'str'  = None,  valueSet:  'str'  = None,  documentation:  'str'  = None,  shortDoco:  'str'  = None,  usage:  list['UsageContext']  = None,  any:  'bool'  = None, ):
        self.id = id 
        self.extension = extension or []
...
class Binding(FhirBaseModel):
    ...
    :param str description: Intended use of codes in the bound value set
    :param str valueSet: Source of value set
    :param Additional additional: Additional Bindings - more rules about the binding
    """
    # needed for complex properties where the element name is different from the class name
    property_class_info = {
        ...
        "additional": {"class_name": "Additional", "is_contained": True},
        
        }
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  strength:  'str'  = None,  description:  'str'  = None,  valueSet:  'str'  = None,  additional:  list['Additional']  = None, ):
        self.id = id 
        self.extension = extension or []
...
class ElementDefinition(FhirBaseModel):
    ...
    :param int defaultValueInteger64: Specified value if missing from instance
    ...
    :param CodeableReference defaultValueCodeableReference: Specified value if missing from instance
    ...
    :param RatioRange defaultValueRatioRange: Specified value if missing from instance
    ...
    :param Availability defaultValueAvailability: Specified value if missing from instance
    :param ExtendedContactDetail defaultValueExtendedContactDetail: Specified value if missing from instance
    ...
    :param int fixedInteger64: Value must be exactly this
    ...
    :param CodeableReference fixedCodeableReference: Value must be exactly this
    ...
    :param RatioRange fixedRatioRange: Value must be exactly this
    ...
    :param Availability fixedAvailability: Value must be exactly this
    :param ExtendedContactDetail fixedExtendedContactDetail: Value must be exactly this
    ...
    :param int patternInteger64: Value must have at least these property values
    ...
    :param CodeableReference patternCodeableReference: Value must have at least these property values
    ...
    :param RatioRange patternRatioRange: Value must have at least these property values
    ...
    :param Availability patternAvailability: Value must have at least these property values
    :param ExtendedContactDetail patternExtendedContactDetail: Value must have at least these property values
    ...
    :param int minValueInteger64: Minimum Allowed Value (for some types)
    ...
    :param int maxValueInteger64: Maximum Allowed Value (for some types)
    ...
    :param int maxLength: Max length for string type data
    ...
    :param bool mustHaveValue: For primitives, that a value must be present - not replaced by an extension
    :param str valueAlternatives: Extensions that are allowed to replace a primitive value
    :param bool mustSupport: If the element must be supported (discouraged - see obligations)
    ...
    property_class_info = {
        ...
        "defaultValueCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
        
        
        "defaultValueCodeableReference": {"class_name": "CodeableReference", "is_contained": False},
        
        
        "defaultValueCoding": {"class_name": "Coding", "is_contained": False},
        
        
        "defaultValueContactPoint": {"class_name": "ContactPoint", "is_contained": False},
        ...
        "defaultValueRatioRange": {"class_name": "RatioRange", "is_contained": False},
        ...
        "defaultValueContactDetail": {"class_name": "ContactDetail", "is_contained": False},
        
        
        "defaultValueDataRequirement": {"class_name": "DataRequirement", "is_contained": False},
        
        
        "defaultValueExpression": {"class_name": "Expression", "is_contained": False},
        
        
        "defaultValueParameterDefinition": {"class_name": "ParameterDefinition", "is_contained": False},
        
        
        "defaultValueRelatedArtifact": {"class_name": "RelatedArtifact", "is_contained": False},
        
        
        "defaultValueTriggerDefinition": {"class_name": "TriggerDefinition", "is_contained": False},
        
        
        "defaultValueUsageContext": {"class_name": "UsageContext", "is_contained": False},
        
        
        "defaultValueAvailability": {"class_name": "Availability", "is_contained": False},
        
        
        "defaultValueExtendedContactDetail": {"class_name": "ExtendedContactDetail", "is_contained": False},
        ...
        "fixedCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
        
        
        "fixedCodeableReference": {"class_name": "CodeableReference", "is_contained": False},
        ...
        "fixedRatioRange": {"class_name": "RatioRange", "is_contained": False},
        ...
        "fixedDataRequirement": {"class_name": "DataRequirement", "is_contained": False},
        
        
        "fixedExpression": {"class_name": "Expression", "is_contained": False},
        
        
        "fixedParameterDefinition": {"class_name": "ParameterDefinition", "is_contained": False},
        
        
        "fixedRelatedArtifact": {"class_name": "RelatedArtifact", "is_contained": False},
        
        
        "fixedTriggerDefinition": {"class_name": "TriggerDefinition", "is_contained": False},
        
        
        "fixedUsageContext": {"class_name": "UsageContext", "is_contained": False},
        
        
        "fixedAvailability": {"class_name": "Availability", "is_contained": False},
        
        
        "fixedExtendedContactDetail": {"class_name": "ExtendedContactDetail", "is_contained": False},
        ...
        "patternCodeableConcept": {"class_name": "CodeableConcept", "is_contained": False},
        
        
        "patternCodeableReference": {"class_name": "CodeableReference", "is_contained": False},
        ...
        "patternRatioRange": {"class_name": "RatioRange", "is_contained": False},
        ...
        "patternDataRequirement": {"class_name": "DataRequirement", "is_contained": False},
        
        
        "patternExpression": {"class_name": "Expression", "is_contained": False},
        
        
        "patternParameterDefinition": {"class_name": "ParameterDefinition", "is_contained": False},
        
        
        "patternRelatedArtifact": {"class_name": "RelatedArtifact", "is_contained": False},
        
        
        "patternTriggerDefinition": {"class_name": "TriggerDefinition", "is_contained": False},
        
        
        "patternUsageContext": {"class_name": "UsageContext", "is_contained": False},
        
        
        "patternAvailability": {"class_name": "Availability", "is_contained": False},
        
        
        "patternExtendedContactDetail": {"class_name": "ExtendedContactDetail", "is_contained": False},
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  path:  'str'  = None,  representation:  list['str']  = None,  sliceName:  'str'  = None,  sliceIsConstraining:  'bool'  = None,  label:  'str'  = None,  code:  list['Coding']  = None,  slicing:  'Slicing'  = None,  short:  'str'  = None,  definition:  'str'  = None,  comment:  'str'  = None,  requirements:  'str'  = None,  alias:  list['str']  = None,  min:  'int'  = None,  max:  'str'  = None,  base:  'Base'  = None,  contentReference:  'str'  = None,  type:  list['Type']  = None,  defaultValueBase64Binary:  'str'  = None,  defaultValueBoolean:  'bool'  = None,  defaultValueCanonical:  'str'  = None,  defaultValueCode:  'str'  = None,  defaultValueDate:  'str'  = None,  defaultValueDateTime:  'str'  = None,  defaultValueDecimal:  'float'  = None,  defaultValueId:  'str'  = None,  defaultValueInstant:  'str'  = None,  defaultValueInteger:  'int'  = None,  defaultValueInteger64:  'int'  = None,  defaultValueMarkdown:  'str'  = None,  defaultValueOid:  'str'  = None,  defaultValuePositiveInt:  'int'  = None,  defaultValueString:  'str'  = None,  defaultValueTime:  'str'  = None,  defaultValueUnsignedInt:  'int'  = None,  defaultValueUri:  'str'  = None,  defaultValueUrl:  'str'  = None,  defaultValueUuid:  'str'  = None,  defaultValueAddress:  'Address'  = None,  defaultValueAge:  'Age'  = None,  defaultValueAnnotation:  'Annotation'  = None,  defaultValueAttachment:  'Attachment'  = None,  defaultValueCodeableConcept:  'CodeableConcept'  = None,  defaultValueCodeableReference:  'CodeableReference'  = None,  defaultValueCoding:  'Coding'  = None,  defaultValueContactPoint:  'ContactPoint'  = None,  defaultValueCount:  'Count'  = None,  defaultValueDistance:  'Distance'  = None,  defaultValueDuration:  'Duration'  = None,  defaultValueHumanName:  'HumanName'  = None,  defaultValueIdentifier:  'Identifier'  = None,  defaultValueMoney:  'Money'  = None,  defaultValuePeriod:  'Period'  = None,  defaultValueQuantity:  'Quantity'  = None,  defaultValueRange:  'Range'  = None,  defaultValueRatio:  'Ratio'  = None,  defaultValueRatioRange:  'RatioRange'  = None,  defaultValueReference:  'Reference'  = None,  defaultValueSampledData:  'SampledData'  = None,  defaultValueSignature:  'Signature'  = None,  defaultValueTiming:  'Timing'  = None,  defaultValueContactDetail:  'ContactDetail'  = None,  defaultValueDataRequirement:  'DataRequirement'  = None,  defaultValueExpression:  'Expression'  = None,  defaultValueParameterDefinition:  'ParameterDefinition'  = None,  defaultValueRelatedArtifact:  'RelatedArtifact'  = None,  defaultValueTriggerDefinition:  'TriggerDefinition'  = None,  defaultValueUsageContext:  'UsageContext'  = None,  defaultValueAvailability:  'Availability'  = None,  defaultValueExtendedContactDetail:  'ExtendedContactDetail'  = None,  defaultValueDosage:  'Dosage'  = None,  defaultValueMeta:  'Meta'  = None,  meaningWhenMissing:  'str'  = None,  orderMeaning:  'str'  = None,  fixedBase64Binary:  'str'  = None,  fixedBoolean:  'bool'  = None,  fixedCanonical:  'str'  = None,  fixedCode:  'str'  = None,  fixedDate:  'str'  = None,  fixedDateTime:  'str'  = None,  fixedDecimal:  'float'  = None,  fixedId:  'str'  = None,  fixedInstant:  'str'  = None,  fixedInteger:  'int'  = None,  fixedInteger64:  'int'  = None,  fixedMarkdown:  'str'  = None,  fixedOid:  'str'  = None,  fixedPositiveInt:  'int'  = None,  fixedString:  'str'  = None,  fixedTime:  'str'  = None,  fixedUnsignedInt:  'int'  = None,  fixedUri:  'str'  = None,  fixedUrl:  'str'  = None,  fixedUuid:  'str'  = None,  fixedAddress:  'Address'  = None,  fixedAge:  'Age'  = None,  fixedAnnotation:  'Annotation'  = None,  fixedAttachment:  'Attachment'  = None,  fixedCodeableConcept:  'CodeableConcept'  = None,  fixedCodeableReference:  'CodeableReference'  = None,  fixedCoding:  'Coding'  = None,  fixedContactPoint:  'ContactPoint'  = None,  fixedCount:  'Count'  = None,  fixedDistance:  'Distance'  = None,  fixedDuration:  'Duration'  = None,  fixedHumanName:  'HumanName'  = None,  fixedIdentifier:  'Identifier'  = None,  fixedMoney:  'Money'  = None,  fixedPeriod:  'Period'  = None,  fixedQuantity:  'Quantity'  = None,  fixedRange:  'Range'  = None,  fixedRatio:  'Ratio'  = None,  fixedRatioRange:  'RatioRange'  = None,  fixedReference:  'Reference'  = None,  fixedSampledData:  'SampledData'  = None,  fixedSignature:  'Signature'  = None,  fixedTiming:  'Timing'  = None,  fixedContactDetail:  'ContactDetail'  = None,  fixedDataRequirement:  'DataRequirement'  = None,  fixedExpression:  'Expression'  = None,  fixedParameterDefinition:  'ParameterDefinition'  = None,  fixedRelatedArtifact:  'RelatedArtifact'  = None,  fixedTriggerDefinition:  'TriggerDefinition'  = None,  fixedUsageContext:  'UsageContext'  = None,  fixedAvailability:  'Availability'  = None,  fixedExtendedContactDetail:  'ExtendedContactDetail'  = None,  fixedDosage:  'Dosage'  = None,  fixedMeta:  'Meta'  = None,  patternBase64Binary:  'str'  = None,  patternBoolean:  'bool'  = None,  patternCanonical:  'str'  = None,  patternCode:  'str'  = None,  patternDate:  'str'  = None,  patternDateTime:  'str'  = None,  patternDecimal:  'float'  = None,  patternId:  'str'  = None,  patternInstant:  'str'  = None,  patternInteger:  'int'  = None,  patternInteger64:  'int'  = None,  patternMarkdown:  'str'  = None,  patternOid:  'str'  = None,  patternPositiveInt:  'int'  = None,  patternString:  'str'  = None,  patternTime:  'str'  = None,  patternUnsignedInt:  'int'  = None,  patternUri:  'str'  = None,  patternUrl:  'str'  = None,  patternUuid:  'str'  = None,  patternAddress:  'Address'  = None,  patternAge:  'Age'  = None,  patternAnnotation:  'Annotation'  = None,  patternAttachment:  'Attachment'  = None,  patternCodeableConcept:  'CodeableConcept'  = None,  patternCodeableReference:  'CodeableReference'  = None,  patternCoding:  'Coding'  = None,  patternContactPoint:  'ContactPoint'  = None,  patternCount:  'Count'  = None,  patternDistance:  'Distance'  = None,  patternDuration:  'Duration'  = None,  patternHumanName:  'HumanName'  = None,  patternIdentifier:  'Identifier'  = None,  patternMoney:  'Money'  = None,  patternPeriod:  'Period'  = None,  patternQuantity:  'Quantity'  = None,  patternRange:  'Range'  = None,  patternRatio:  'Ratio'  = None,  patternRatioRange:  'RatioRange'  = None,  patternReference:  'Reference'  = None,  patternSampledData:  'SampledData'  = None,  patternSignature:  'Signature'  = None,  patternTiming:  'Timing'  = None,  patternContactDetail:  'ContactDetail'  = None,  patternDataRequirement:  'DataRequirement'  = None,  patternExpression:  'Expression'  = None,  patternParameterDefinition:  'ParameterDefinition'  = None,  patternRelatedArtifact:  'RelatedArtifact'  = None,  patternTriggerDefinition:  'TriggerDefinition'  = None,  patternUsageContext:  'UsageContext'  = None,  patternAvailability:  'Availability'  = None,  patternExtendedContactDetail:  'ExtendedContactDetail'  = None,  patternDosage:  'Dosage'  = None,  patternMeta:  'Meta'  = None,  example:  list['Example']  = None,  minValueDate:  'str'  = None,  minValueDateTime:  'str'  = None,  minValueInstant:  'str'  = None,  minValueTime:  'str'  = None,  minValueDecimal:  'float'  = None,  minValueInteger:  'int'  = None,  minValueInteger64:  'int'  = None,  minValuePositiveInt:  'int'  = None,  minValueUnsignedInt:  'int'  = None,  minValueQuantity:  'Quantity'  = None,  maxValueDate:  'str'  = None,  maxValueDateTime:  'str'  = None,  maxValueInstant:  'str'  = None,  maxValueTime:  'str'  = None,  maxValueDecimal:  'float'  = None,  maxValueInteger:  'int'  = None,  maxValueInteger64:  'int'  = None,  maxValuePositiveInt:  'int'  = None,  maxValueUnsignedInt:  'int'  = None,  maxValueQuantity:  'Quantity'  = None,  maxLength:  'int'  = None,  condition:  list['str']  = None,  constraint:  list['Constraint']  = None,  mustHaveValue:  'bool'  = None,  valueAlternatives:  list['str']  = None,  mustSupport:  'bool'  = None,  isModifier:  'bool'  = None,  isModifierReason:  'str'  = None,  isSummary:  'bool'  = None,  binding:  'Binding'  = None,  mapping:  list['Mapping']  = None, ):
        ...
        self.defaultValueInteger64 = defaultValueInteger64 
        ...
        self.defaultValueCodeableReference = defaultValueCodeableReference 
        ...
        self.defaultValueRatioRange = defaultValueRatioRange 
        ...
        self.defaultValueAvailability = defaultValueAvailability 
        self.defaultValueExtendedContactDetail = defaultValueExtendedContactDetail 
        ...
        self.fixedInteger64 = fixedInteger64 
        ...
        self.fixedCodeableReference = fixedCodeableReference 
        ...
        self.fixedRatioRange = fixedRatioRange 
        ...
        self.fixedExtendedContactDetail = fixedExtendedContactDetail 
        ...
        self.patternInteger64 = patternInteger64 
        ...
        self.patternCodeableReference = patternCodeableReference 
        ...
        self.patternRatioRange = patternRatioRange 
        ...
        self.patternAvailability = patternAvailability 
        self.patternExtendedContactDetail = patternExtendedContactDetail 
        ...
        self.minValueInteger64 = minValueInteger64 
        ...
        self.maxValueInteger64 = maxValueInteger64 
        ...
        self.valueAlternatives = valueAlternatives or []
