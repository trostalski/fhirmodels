...
class Attachment(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  contentType:  'str'  = None,  language:  'str'  = None,  data:  'str'  = None,  url:  'str'  = None,  size:  'int'  = None,  hash:  'str'  = None,  title:  'str'  = None,  creation:  'str'  = None,  height:  'int'  = None,  width:  'int'  = None,  frames:  'int'  = None,  duration:  'float'  = None,  pages:  'int'  = None, ):
