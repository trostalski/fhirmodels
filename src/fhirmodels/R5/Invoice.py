...
class LineItem(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  sequence:  'int'  = None,  servicedDate:  'str'  = None,  servicedPeriod:  'Period'  = None,  chargeItemReference:  'Reference'  = None,  chargeItemCodeableConcept:  'CodeableConcept'  = None,  priceComponent:  list['MonetaryComponent']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
...
class Invoice(DomainResource):
    ...
    def __init__(self,  id:  'str'  = None,  meta:  'Meta'  = None,  implicitRules:  'str'  = None,  language:  'str'  = None,  text:  'Narrative'  = None,  contained:  list['Resource']  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  list['Identifier']  = None,  status:  'str'  = None,  cancelledReason:  'str'  = None,  type:  'CodeableConcept'  = None,  subject:  'Reference'  = None,  recipient:  'Reference'  = None,  date:  'str'  = None,  creation:  'str'  = None,  periodDate:  'str'  = None,  periodPeriod:  'Period'  = None,  participant:  list['Participant']  = None,  issuer:  'Reference'  = None,  account:  'Reference'  = None,  lineItem:  list['LineItem']  = None,  totalPriceComponent:  list['MonetaryComponent']  = None,  totalNet:  'Money'  = None,  totalGross:  'Money'  = None,  paymentTerms:  'str'  = None,  note:  list['Annotation']  = None, ):
