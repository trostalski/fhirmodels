...
class Filter(FhirBaseModel):
    ...
    :param str operator: = | is-a | descendent-of | is-not-a | regex | in | not-in | generalizes | child-of | descendent-leaf | exists
...
class CodeSystem(DomainResource):
    ...
    :param str approvalDate: When the CodeSystem was approved by publisher
    :param str lastReviewDate: When the CodeSystem was last reviewed by the publisher
    :param Period effectivePeriod: When the CodeSystem is expected to be used
    :param CodeableConcept topic: E.g. Education, Treatment, Assessment, etc
    :param ContactDetail author: Who authored the CodeSystem
    :param ContactDetail editor: Who edited the CodeSystem
    :param ContactDetail reviewer: Who reviewed the CodeSystem
    :param ContactDetail endorser: Who endorsed the CodeSystem
