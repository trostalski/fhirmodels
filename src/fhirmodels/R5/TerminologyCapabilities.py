...
class Filter(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  code:  'str'  = None,  op:  list['str']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.code = code 
...
class Version(FhirBaseModel):
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  code:  'str'  = None,  isDefault:  'bool'  = None,  compositional:  'bool'  = None,  language:  list['str']  = None,  filter:  list['Filter']  = None,  property:  list['str']  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.code = code 
...
class CodeSystem(FhirBaseModel):
    ...
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
    :param str uri: Canonical identifier for the code system, represented as a URI
    ...
    def __init__(self,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  uri:  'str'  = None,  version:  list['Version']  = None,  content:  'str'  = None,  subsumption:  'bool'  = None, ):
        self.id = id 
        self.extension = extension or []
        self.modifierExtension = modifierExtension or []
        self.uri = uri 
...
class Parameter(FhirBaseModel):
    ...
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
    :param str name: Name of the supported expansion parameter
...
class ValidateCode(FhirBaseModel):
...
class Translation(FhirBaseModel):
...
class TerminologyCapabilities(DomainResource):
    ...
    :param Identifier identifier: Additional identifier for the terminology capabilities
    ...
    :param str codeSearch: in-compose | in-expansion | in-compose-or-expansion
